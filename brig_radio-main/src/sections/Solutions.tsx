...
const features = [
  ...
  },
  {
    ...
    benefits: ['Official only', 'Like & comment', 'Instant notification'],
  },
  {
    icon: Briefcase,
    title: 'Placement Hub',
    description: 'All job and internship opportunities organized in one place.  bookmark favorites, and never miss an opportunity.',
    color: 'bg-green-500',
    lightColor: 'bg-green-50',
    image: '/images/app/app-placements-new.jpeg',
    benefits: [, 'Bookmark jobs', 'Direct apply links', 'Know about achievements in campus '],
  },
  {
    icon: Lightbulb,
    title: 'Student Suggestions',
    description: 'Submit radio ideas and get notified when approved. Your voice matters - contribute to making campus life better for everyone.',
    color: 'bg-amber-500',
    lightColor: 'bg-amber-50',
    image: '/images/app/app-propose-session.png',
    benefits: ['Idea submission', 'Notify when approved',],
  },
