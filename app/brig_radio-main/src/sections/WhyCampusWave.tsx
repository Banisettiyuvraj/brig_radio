...
const benefits = [
  {
    ...
    description: 'Never miss another job opportunity with timely notifications ',
    stat: '95%',
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Benefits Grid - Centered Flex for 2 items */}
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                ...
                className="group relative bg-white rounded-3xl p-8 shadow-card border border-gray-100
                         hover:shadow-card-hover hover:-translate-y-2 transition-all duration-500
                         w-full sm:w-[calc(50%-1rem)] lg:w-[calc(50%-1.5rem)] max-w-md"
              >
                {/* Top Accent */}
