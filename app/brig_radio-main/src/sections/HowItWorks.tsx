...
const steps = [
  {
    ...
    description: 'Get BrigRadio from below download button. iOS version coming soon!',
  ...
  },
  {
    ...
    description: 'Participate in campus life like never before. Share, and engage!',
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className="text-center mb-20">
          ...
          <p className="body-lg max-w-2xl mx-auto">
            Get started with BrigRadio in four simple steps
          </p>
        </div>
