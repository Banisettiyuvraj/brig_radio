...
import { Code2, BookOpen, Award, Users, Linkedin } from 'lucide-react';
        ...
        <div className="flex items-center justify-center gap-4 mt-8">
          {member.linkedin && (
            <a
              ...
              className={`w-10 h-10 rounded-xl bg-gradient-to-br ${member.gradient} p-[1px]
                         transition-all duration-300 hover:scale-110 hover:shadow-lg group/link`}
            >
              <div className="w-full h-full bg-white rounded-[11px] flex items-center justify-center
                            transition-colors duration-300 group-hover/link:bg-transparent">
                <Linkedin className={`w-5 h-5 text-gray-600 transition-colors duration-300 
